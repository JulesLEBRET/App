...
class PaintsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create paint" do
    assert_difference('Paint.count') do
      post paints_url, params: { paint: { author: @paint.author, date: @paint.date, description: @paint.description, dimension: @paint.dimension, location: @paint.location, name: @paint.name } }
    end
  ...
  test "should update paint" do
    patch paint_url(@paint), params: { paint: { author: @paint.author, date: @paint.date, description: @paint.description, dimension: @paint.dimension, location: @paint.location, name: @paint.name } }
